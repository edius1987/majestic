...
# Última alteração: 2018-07-26 00:02:46
...
resolucoesx=("2560" "1920" "1680" "1440" "1280" "1080" "720" "640" "480" "320")
resolucoesy=("1600" "1200" "1050" "900" "800" "600" "480" "320")
...
if [ $altura -gt $largura ]; then

for r in ${resolucoesx[@]}; do
