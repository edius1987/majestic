...
# Última alteração: 2018-07-20 11:42:40
...
resolucao=$(yad --form --width=400 --title "$titulo" --separator="!" --image=gnome-shutdown --button="gtk-close:1" --button="gtk-ok:0" --field="Arquivo:SFL" --field="Resolução:CB" "$novo" $(echo ${res%?} | awk '{$1=$1};1'))
[[ -z $resolucao ]] && exit 1
